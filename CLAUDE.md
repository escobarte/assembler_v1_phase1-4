...
Aesthetics and tokens strictly follow cc_design/DESIGN.md.

While we use shadcn/ui for functionality, you MUST override their default styles in globals.css and Tailwind classes to match the brutalist, high-contrast, large-typography style defined in DESIGN.md. (e.g., massive paddings, high contrast, specific fonts).

Animations
Framer Motion: Use it to replicate the premium feel of high-end Framer sites.

Add subtle fade-in and slide-up animations on scroll for major layout sections.

Keep animations buttery smooth and minimal. No bouncy or cheap transitions.
...
Visual Hierarchy
H1 / Primary CTA must be immediately dominant — use font-bold or font-black for headings
